...
<html>
    ...
    <body>
        ...
        <form class="prijava-korisnika" action="<?php echo BASE_URL; ?>login/logovanje" method="post">
            ...
            <div class="container">
                ...
                <a class="promijeni_password" href="<?php echo BASE_URL; ?>login/promijeni-password">Promijeni Password</a>
            </div>
